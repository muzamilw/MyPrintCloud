    ...
    public class ItemSectionService : IItemSectionService
    {
        ...
        public ItemSection GetUpdatedSectionWithSystemCostCenters(ItemSection currentSection)
        {
            ...
            if (currentSection.SectionCostcentres != null)
                currentSection.SectionCostcentres.Where(a => SystemCostCenterTypes.Contains(a.SystemCostCentreType ?? 0) || a.Name == "Web Order Cost Center" || a.Name == "Blank Sheet").ToList().ForEach(a => currentSection.SectionCostcentres.Remove(a));
