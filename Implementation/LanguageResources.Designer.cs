...
namespace MPC.Implementation {
    ...
    internal class LanguageResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Please select a paper that can be supported by the selected press..
        /// </summary>
        internal static string ItemService_PressNoSupported {
            get {
                return ResourceManager.GetString("ItemService_PressNoSupported", resourceCulture);
            }
        }
