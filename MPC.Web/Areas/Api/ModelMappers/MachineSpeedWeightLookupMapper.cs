...
{
    public static class MachineSpeedWeightLookupMapper
    {
        public static DomainModel.MachineSpeedWeightLookup CreateFrom(this ApiModel.MachineSpeedWeightLookup source)
        {
            return new DomainModel.MachineSpeedWeightLookup
            {
                Id = source.Id,
        ...
        public static ApiModel.MachineSpeedWeightLookup CreateFrom(this DomainModel.MachineSpeedWeightLookup source)
        {
            return new ApiModel.MachineSpeedWeightLookup
            {
                Id = source.Id,
                MethodId = source.MethodId,
                SheetsQty1 = source.SheetsQty1,
