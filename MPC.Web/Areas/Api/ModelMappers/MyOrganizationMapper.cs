    ...
    public static class MyOrganizationMapper
    {
        ...
        public static Organisation CreateFrom(this DomainModels.Organisation source)
        {
            ...
            return new Organisation
           {
               ...
               MailChimpApikey = source.MailChimpApikey,
               MailChimpApiId = source.MailChimpApiId,
               isMailChimpActive = source.isMailChimpActive,
               MailChimpListName = source.MailChimpListName,
               OrderHeadNote = source.OrderHeadNote,
                OrderFootNote = source.OrderFootNote,
                InvoiceHeadNote = source.InvoiceHeadNote,
                InvoiceFootNote = source.InvoiceFootNote,
                DeliveryHeadNote = source.DeliveryHeadNote,
                DeliveryFootNote = source.DeliveryFootNote,
                PurchaseHeadNote = source.PurchaseHeadNote,
                PurchaseFootNote = source.PurchaseFootNote,
                XeroConsumerKey = source.XeroConsumerKey,
