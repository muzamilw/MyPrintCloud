    ...
    public class InvoicesByOrganisationController : ApiController
    {
        ...
        public HttpResponseMessage Get()
        {
            try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, _invoiceService.GetInvoiceDetailForZapierPooling(organisationId), formatter);
        ...
        private string GetActiveOrganisationId(string param)
        {
            ...
            string credentials = !string.IsNullOrEmpty(param)? param.Substring(param.IndexOf("username="),
                param.Length - param.IndexOf("username=")) : string.Empty;
