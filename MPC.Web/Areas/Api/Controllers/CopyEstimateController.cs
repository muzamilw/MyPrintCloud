...
{
    public class CopyEstimateController : ApiController
    { 
        #region Private
        ...
        /// Constructor
        /// </summary>
        public CopyEstimateController(IOrderService orderService)
        {
        ...
        public Estimate Get(int id)
        {
            ...
            return orderService.CloneEstimate(id).CreateFrom();
        }
        #endregion
    }
}