        ...
        InventoryCategory = function (specifiedCategoryId, specifiedCode, specifiedName, specifiedDescription, specifiedFixed, specifiedItemWeight,
            ...
            var
             ...
             convertToServerData = function (source) {
                 ...
                 result.Fixed = source.fixed() == false || source.fixed() === undefined ? 0 : 1;
                 result.ItemWeight = source.itemWeight() == false || source.itemWeight() === undefined ? 0 : 1;
                 result.ItemColour = source.itemColour() == false || source.itemColour() === undefined ? 0 : 1;
                 result.ItemSizeCustom = source.itemSizeCustom() == false || source.itemSizeCustom() === undefined ? 0 : 1;
                 result.ItemPaperSize = source.itemPaperSize() == false || source.itemPaperSize() === undefined ? 0 : 1;
                 result.ItemCoatedType = source.itemCoatedType() == false || source.itemCoatedType() === undefined ? 0 : 1;
                 result.ItemCoated = source.itemCoated() == false || source.itemCoated() === undefined ? 0 : 1;
                 result.ItemExposure = source.itemExposure() == false || source.itemExposure() === undefined ? 0 : 1;
                 result.ItemCharge = source.itemCharge() == false || source.itemCharge() === undefined ? 0 : 1;
                 result.RecLock = source.recLock() == false || source.recLock() === undefined ? 0 : 1;
                 result.TaxId = source.taxId();
                 result.Flag1 = source.flag1() == false || source.flag1() === undefined ? 0 : 1;
                 result.Flag2 = source.flag2() == false || source.flag2() === undefined ? 0 : 1;
                 result.Flag3 = source.flag3() == false || source.flag3() === undefined ? 0 : 1;
                 result.Flag4 = source.flag4() == false || source.flag4() === undefined ? 0 : 1;
