        ...
        ist.addProduct = {
            viewModel: (function () {
                var // The view 
                    ...
                    //    if (selectedStockOption() !== undefined && selectedStockOption().itemAddonCostCentres !== undefined && selectedStockOption().itemAddonCostCentres().length>0) {
                    //        var total = 0;
                    //        _.each(selectedStockOption().itemAddonCostCentres(), function(item) {
                    //            total = total + item.totalPriceWithTax();
                    //        });
                    //    }
                    //    addsOnTotal(total);
                    //}),
