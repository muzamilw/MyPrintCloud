...
/*WHERE        (PCat.isArchived = 0)*/
CREATE VIEW [dbo].[GetItemsListView]
AS
...
FOR XML PATH(''), TYPE
        ...
        ,1,2,'')) ProductCategoryName,
						 ...
						 p.OrganisationId, p.WebDescription, p.PriceDiscountPercentage, p.DefaultItemTax, p.isUploadImage, p.CompanyId
FROM            dbo.Items p
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'GetItemsListView';
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[33] 4[17] 2[19] 3) )"
      End
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'GetItemsListView';
