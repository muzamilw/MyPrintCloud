CREATE TABLE [dbo].[MachineSpeedWeightLookup] (
    ...
    [hourlyPrice]  FLOAT (53) CONSTRAINT [DF__tbl_machi__hourl__01342732] DEFAULT (0) NOT NULL,
    CONSTRAINT [PK_tbl_machine_speedweightlookup] PRIMARY KEY CLUSTERED ([Id] ASC),
    CONSTRAINT [FK_tbl_lookup_methods_tbl_machine_speedweightlookup] FOREIGN KEY ([MethodId]) REFERENCES [dbo].[LookupMethod] ([MethodId])
);
