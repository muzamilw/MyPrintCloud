CREATE PROCEDURE dbo.sp_Scheduling_get_TimeActivitiesByCostCenterID
...
SELECT  
                              ...
                              tbl_scheduled_time_activities.JobID, 
                                                ...
                                                AND ( tbl_scheduled_costcenters.ResourcesID = @ResourcesID  and tbl_scheduled_time_activities.IsInEditing = @IsInEditing)
	RETURN