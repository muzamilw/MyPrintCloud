CREATE PROCEDURE [dbo].[sp_Suppliers_Address_GetSupplierDefaultAddress]
	(
	@SupplierID int
	)
AS
	SELECT tbl_Addresses.AddressID,tbl_Addresses.ContactCompanyID,
         ...
         tbl_Addresses.FAO,tbl_Addresses.IsDefaultAddress
          FROM tbl_Addresses
         WHERE (tbl_Addresses.ContactCompanyID=@SupplierID) AND (IsDefaultAddress =1)
	RETURN