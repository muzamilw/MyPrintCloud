CREATE PROCEDURE dbo.sp_Scheduling_get_TimeActivitiesByMachineID
...
AS
	SELECT  
                                              ...
                                              tbl_scheduled_time_activities.JobID, 
                                                ...
                                                AND ( tbl_scheduled_printjobs.MachineID = @MachineID And  tbl_scheduled_printjobs.MachineType = @MachineType and tbl_scheduled_time_activities.IsInEditing = @IsInEditing)
	RETURN