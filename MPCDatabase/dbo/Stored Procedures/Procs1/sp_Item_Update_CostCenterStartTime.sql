...
Create PROCEDURE [dbo].[sp_Item_Update_CostCenterStartTime]
...
update tbl_section_costcentres set EstimatedStartTime = @CostCenterStartTime  ,EstimatedEndTime = DATEADD(hour,isnull(@CostCenterDuration,0),@CostCenterStartTime)
where SectionCostcentreID=@CostCenterID
