...
Create PROCEDURE [dbo].[sp_ItemSectionCostCentre_Get_MachineCotCentresBySectionID]
(
	@SectionID int
)
AS
...
Where   tbl_section_costcentres.ItemSectionID = @SectionID and (tbl_section_costcentres.SystemCostCentreType = 6 or tbl_section_costcentres.SystemCostCentreType = 8 ) 
and  IsScheduled = 0  and tbl_costcentres.IsScheduleable <> 0
