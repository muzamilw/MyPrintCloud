CREATE PROCEDURE dbo.sp_PipeLine_Get_MonthlySalesTargetByMonthByUserID
	@Month int,@SalesYear int,
	@SystemUserID int
AS
    ...
    WHERE tbl_user_sales_targets.SystemUserID = @SystemUserID and 
    tbl_user_sales_targets.Month=@Month AND tbl_user_sales_targets.Year=@SalesYear and tbl_user_sales_targets.SalesTargetTypeID=1 
	RETURN