...
//@line 41 "k:\Hudson\jobs\k2-mozilla20\workspace\xulrunner\setup\nsXULAppInstall.js"
...
AppInstall.prototype = {
  ...
  installApplication : function ai_IA(aAppFile, aDirectory, aLeafName) {
    ...
    if (aDirectory == null) {
//@line 235 "k:\Hudson\jobs\k2-mozilla20\workspace\xulrunner\setup\nsXULAppInstall.js"
      aDirectory = getDirectoryKey("ProgF");
      if (vendor)
        aDirectory.append(vendor);
//@line 251 "k:\Hudson\jobs\k2-mozilla20\workspace\xulrunner\setup\nsXULAppInstall.js"
    }
    else {
    ...
    if (aLeafName == "") {
//@line 265 "k:\Hudson\jobs\k2-mozilla20\workspace\xulrunner\setup\nsXULAppInstall.js"
      aLeafName = appName;
//@line 270 "k:\Hudson\jobs\k2-mozilla20\workspace\xulrunner\setup\nsXULAppInstall.js"
    }
...
//@line 341 "k:\Hudson\jobs\k2-mozilla20\workspace\xulrunner\setup\nsXULAppInstall.js"
...
//@line 348 "k:\Hudson\jobs\k2-mozilla20\workspace\xulrunner\setup\nsXULAppInstall.js"
  }
};
