<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ThemeSite.Master" AutoEventWireup="true"
    CodeBehind="BrokerProductPendingOrders.aspx.cs" Inherits="Web2Print.UI.BrokerProductPendingOrders" %>
    ...
    <div class="content_area">
        <div class="left_right_padding">
            <uc1:BreadCrumbMenu ID="BreadCumbMenuCategory" runat="server" WorkMode="MyAccount"
                MyAccountCurrentPage="Broker Pending Orders" MyAccountCurrentPageUrl="BrokerProductPendingOrders.aspx" />
            ...
            <div class="white_back_div rounded_corners">
                ...
                <div id="NoPrdersCon" class="Width100Percent" runat="server">
                ...
                <div id="DescriptCont" class="Width100Percent" runat="server">
                    <div class="textAlignLeft paddingLeft10px paddingBottom10px product_detail_sub_heading custom_color paddingTop15px">
                        <asp:Label ID="Label2" runat="server" Text="These orders require URGENT review:" />
                    </div>
                </div>
                <%--The Main Container--%>
