...
namespace MPC.Webstore.Common
{
    public class OAuthHelper
    {
        ...
        static string callbackUrl = HttpContext.Current.Request.Url.Scheme + "://" + HttpContext.Current.Request.Url.Authority + "/oauth.aspx";
        ...
        public void GetUserTwAccessToken(string oauth_token, string oauth_verifier, string oauth_consumer_key, string oauth_consumer_secret)
        {
            string webResponse = "";
        ...
        public void TweetOnBehalfOf(string oauth_access_token, string oauth_token_secret, string postData, string oauth_consumer_key, string oauth_consumer_secret)
        {
