...
namespace MPC.Webstore.Areas.Designer.Controllers
{
    public class DesignerController : Controller
    {
        ...
        public ActionResult Index(string designName, int categoryIDV2, long templateID, long itemID, long customerID, long contactID, int isCalledFrom, long organisationId, bool printCropMarks, bool printWaterMarks, bool isEmbedded, int territoryId = 0, int colorTerritoryId = 0, bool damEnabled = false, long DamTerritoryID = 0)
        {
