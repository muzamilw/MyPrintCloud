    ...
    public class DesignerAreaRegistration : AreaRegistration 
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context) 
        {
            ...
            context.MapRoute(
                  ...
                  AreaName + "/{designName}/{categoryIDV2}/{templateID}/{itemID}/{customerID}/{contactID}/{isCalledFrom}/{organisationId}/{printCropMarks}/{printWaterMarks}/{isEmbedded}/{territoryId}/{colorTerritoryId}/{damEnabled}",
