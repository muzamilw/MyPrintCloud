    ...
    public class DesignerAreaRegistration : AreaRegistration 
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context) 
        {
            ...
            context.MapRoute(
                  ...
                  AreaName + "/{designName}/{categoryIDV2}/{templateID}/{itemID}/{customerID}/{contactID}/{isCalledFrom}/{organisationId}/{printCropMarks}/{printWaterMarks}/{isEmbedded}/{territoryId}/{colorTerritoryId}/{damEnabled}/{DamTerritoryID}",
                  new { controller = "Designer", action = "Index", designName = RouteParameter.Optional, categoryIDV2 = RouteParameter.Optional, templateID = RouteParameter.Optional, itemID = RouteParameter.Optional, customerID = RouteParameter.Optional, contactID = RouteParameter.Optional, isCalledFrom = RouteParameter.Optional, organisationId = RouteParameter.Optional, printCropMarks = RouteParameter.Optional, printWaterMarks = RouteParameter.Optional, isEmbedded = RouteParameter.Optional, territoryId = RouteParameter.Optional, colorTerritoryId = RouteParameter.Optional, damEnabled = RouteParameter.Optional, DamTerritoryID = RouteParameter.Optional }
            );
        }
    }
}