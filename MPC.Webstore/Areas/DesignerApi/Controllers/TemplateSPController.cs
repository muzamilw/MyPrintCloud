...
namespace MPC.Webstore.Areas.DesignerApi.Controllers
{
    public class TemplateSPController : ApiController
    {
        ...
        public HttpResponseMessage GetTemplate(int id)
        {
            ...
            //return Ok();
        //    return JsonConvert.SerializeObject(template, Newtonsoft.Json.Formatting.Indented, new JsonSerializerSettings() { ReferenceLoopHandling = ReferenceLoopHandling.Ignore });
        //    return Request.CreateResponse(HttpStatusCode.OK, JsonConvert.SerializeObject(template, Newtonsoft.Json.Formatting.Indented, new JsonSerializerSettings() { ReferenceLoopHandling = ReferenceLoopHandling.Ignore }), Configuration.Formatters.JsonFormatter);
           // return ;
