...
{
    public class FutureQuickLinksController : Controller
    {
         #region Private
        ...
        /// Constructor
        /// </summary>
        public FutureQuickLinksController(ICompanyService myCompanyService)
        {
        ...
        public ActionResult Index()
        {
            ...
            if (StoreBaseResopnse.Company.isDisplaySecondaryPages == true)
            {
                ...
                if (oPageCategories != null && oPageCategories.Count() > 2)
                {
                    ViewData["PageCategory"] = oPageUpdateCategories.Take(2).ToList();
                }
                else 
                {
            ...
            return PartialView("PartialViews/FutureQuickLinks", oAddress);
        }
    }
}