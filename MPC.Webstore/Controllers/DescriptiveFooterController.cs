...
{
    public class DescriptiveFooterController : Controller
    {
        ...
        /// Constructor
        /// </summary>
        public DescriptiveFooterController(ICompanyService myCompanyService, ICampaignService campaignService, IUserManagerService userManagerService
        ...
        public ActionResult Index()
        {
            ...
            return PartialView("PartialViews/DescriptiveFooter", StoreBaseResopnse.Company);
        }
         [HttpPost]
