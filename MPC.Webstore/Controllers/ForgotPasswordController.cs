    ...
    public class ForgotPasswordController : Controller
    {
        ...
        private void SendEmail(string Email, MPC.Models.ResponseModels.MyCompanyDomainBaseReponse companyDomain)
        {
            ...
            if (curUser != null)
            {
                ...
                Campaign ForgotPasswordCampaign = _campaignService.GetCampaignRecordByEmailEvent((int)Events.ForgotPassword, companyDomain.Company.OrganisationId ?? 0, UserCookieManager.StoreId);
