        ...
        private void SendEmail(string Email, MyCompanyDomainBaseResponse companyDomain)
        {
            ...
            objtCEP.CompanySiteID = 1;
                ...
                if (curUser != null)
                {
                    ...
                    objtCEP.StoreID = (int)companyDomain.Organisation.OrganisationId;
                    ...
                    else
                    {
                        ...
                        SystemUser EmailOFSM = _UserManagerService.GetSalesManagerDataByID(Convert.ToInt32(companyDomain.Organisation.OrganisationId));
                          result =  _campaignService.emailBodyGenerator(ForgotPasswordCampaign, null, objtCEP, CustomerEmailAcc, StoreMode.Retail , (int)companyDomain.Organisation.OrganisationId, autoGeneratedPss, "", "", EmailOFSM.Email, "", "", null, "");
                    }
                    ...
                    //{
                    //    lblMessage.Visible = true;
                    //    //lblMessage.Text = "Answer is incorrect. Please try again!";
                    //    lblMessage.Text = (string)GetGlobalResourceObject("MyResource", "hfAnswerIncorrect");
                    //    trQuestion.Visible = true;
                    //    rfvSecretAns.Enabled = true;
                    //    vceSecretAns.Enabled = true;
                    //    Counter = 1;
                    //}
                }
                else
