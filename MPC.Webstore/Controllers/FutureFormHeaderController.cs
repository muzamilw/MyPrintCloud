...
{
    public class FutureFormHeaderController : Controller
    {
        // GET: FutureFormHeader
        private ICompanyService _myCompanyService;

        public FutureFormHeaderController(ICompanyService _myCompanyService)
        {
        ...
        public ActionResult Index()
        {
            ...
            return PartialView("PartialViews/FutureFormHeader");
        }
    }
}