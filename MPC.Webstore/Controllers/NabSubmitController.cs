                                ...
                                if (ResponseStatusCode == "00" || ResponseStatusCode == "08")
                                {
                                    ...
                                    if (modelOrder.StatusId == 3)
                                    {
                                        ...
                                        if (CustomerCompany.IsCustomer == (int)CustomerTypes.Corporate)
                                        {
                                            ...
                                            _campaignService.SendEmailToSalesManager((int)Events.NewOrderToSalesManager, Convert.ToInt32(modelOrder.ContactId), Convert.ToInt32(modelOrder.CompanyId), 0, model.OrderId, 0, Convert.ToInt32(ManagerID), StoreMode.Corp, CustomerCompany, EmailOFSM);
                                        }
                                        else
                                        {

                                            _campaignService.SendEmailToSalesManager((int)Events.NewQuoteToSalesManager, (int)modelOrder.ContactId, (int)modelOrder.CompanyId, 0, model.OrderId, 0, 0, StoreMode.Retail, CustomerCompany, EmailOFSM);
                                        }
