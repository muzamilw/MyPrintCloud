...
;
        ...
        [HttpPost]
        public JsonResult SendSubsricptionDAta(string txtEmailbox)
        {
            ...
            try
            {
                ...
                if (subscriber == null)
                {
                    ...
                    if (string.IsNullOrEmpty(sConfirmation))
                    {
                        Message = Utils.GetKeyValueFromResourceFile("ltrlsubps", UserCookieManager.WBStoreId, "To confirm your subscription please follow instructions which have been sent to provided email.");
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (string.IsNullOrEmpty(sConfirmation))
                    {
                        Message = Utils.GetKeyValueFromResourceFile("SubscriptionErrorMesg", UserCookieManager.WBStoreId, "Someone is already subscribed with provided email. Please use a different email.")
;
                    }
                    else
                    {
