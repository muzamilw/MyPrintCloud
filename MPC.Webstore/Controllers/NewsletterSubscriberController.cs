...
namespace MPC.Webstore.Controllers
{
    public class NewsletterSubscriberController : Controller
    {
        ...
        public ActionResult Index(string txtEmailbox)
        {
            ...
            //    subscriber = SubscriberManager.GetSubscriber(txtEmailbox);
            ...
            //        subscriber = new tbl_NewsLetterSubscribers();
            ...
            //        CEP.SubscriberID = SubscriberManager.AddSubscriber(subscriber);
