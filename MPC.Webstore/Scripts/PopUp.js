...
function ViewOrderPopUp(Type, panelHtml) {
    ...
    function EmailProofsPopup(title) {
        ...
        var container = '<div class="md-content"><div class="modal-header"><button class="md-close close" onclick=HideMessagePopUp(); >&times;</button><h4 style="font-size:15px!important;" class="modal-title">' + title + '</h4></div><div class="modal-body"><div id="proofMesges" style="color: red;  display:none;      font-size: 12px;        text-align: center;        margin-bottom: 5px;"></div><div style="float:left;margin-left:50px;margin-top:4px;"><span>E-mail Address 1</span></div><div><input style="float:left;margin-left:11px;" type="text" id="Email1"  class="rounded_corners5 text_box" ></input></div><div style="clear:both;"></div><br/><div style="float:left;margin-left:50px;margin-top:4px;"><span>E-mail Address 2</span></div><div style="float:left"><input style="margin-left:11px;" type="text" id="Email2"  class="rounded_corners5 text_box" ></input></div><div style="clear:both;"></div><div class="modal-footer" style="margin-left: -20px;margin-right: -20px;"><button type="button" id="OrderSave" class="btn btn-primary" onclick="SendProofs()">Send</button><button type="button" id="Close" class="btn btn-primary" onclick="Cancel()">Close</button></div></div>';
