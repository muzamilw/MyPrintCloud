...
function mcImgSlider(j) {
    ...
    x.prototype = {k: {c: j.transitionTime,a: function() {
            },b: x.a.f,d: 1},c: function() {
    ...
    var h = new x, b = {a: 0,e: "",d: 0,c: 0,b: 0}, a, e, s, w, L, G, N, k, n, Q, C, r, A, B, q, U, I, o, l = null, X = function(b) {
        if (b == "series1")
        ...
        a = {b: j.pauseTime,c: j.transitionTime,f: j.slices,g: j.boxes,O0: j.license || "5432",h: j.hoverPause,i: j.autoAdvance,j: j.captionOpacity,k: j.captionEffect == "none" ? 0 : j.captionEffect == "fade" ? 1 : 2,l: j.thumbnailsWrapperId,Ob: function() {
    ...
    function db() {
        ...
        if (a.l)
            g = K(a.l);
        if (g)
            for (var h = g.childNodes, f = 0; f < h[d]; f++)
                h[f][m] == "thumb" && u.push(h[f]);
        var c = u[d];
        if (c) {
            while (c--) {
                u[c].on = 0;
    ...
    ab.prototype = { c: function () {
        ...
        if (this.z(h) && h[p]("autoPlayVideo") == "true")
            this.d(h);
        else if (a.i && b.d > 1)
        ...
        if (a.k == 2) {
            C = A = { opacity: 0, width: 0, marginLeft: Math.round(Q[2] / 2) };
            r = { opacity: 1, width: Q[2], marginLeft: 0 };
            B = { opacity: a.j, width: Q[2], marginLeft: 0 }
        } else if (a.k == 1) {
            C = A = { opacity: 0 };
            r = { opacity: 1 };
            B = { opacity: a.j }
        ...
        if (G.innerHTML[d] > 1)
            if (!a.k)
                ...
                e = 0;
                var b = { c: a.c * .3, b: a.k == 1 ? x.a.f : x.a.h, d: a.k == 1 ? 0 : 2 }, i = b;
                i.a = function () {
                    k[c][z] = n[c][z] = "hidden";
                    l.m()
                };
        ...
        if (L) {
            ...
            if (a.k) {
                ...
                if (d > 1e3)
                    d = 1e3;
                var b = { c: d, b: a.k == 1 ? x.a.g : x.a.j, d: a.k == 1 ? 0 : 2 };
                if (typeof r[t] !== "undefined") {
        ...
        for (var h = 0, i = e < 7 ? { height: 0, opacity: -.4} : { width: 0, opacity: 0 }, k = { height: w, opacity: 1 }, a = 0, j = b[d]; a < j; a++) {
            if (e < 3)
                b[a][c].bottom = "0";
            else if (e < 5)
                b[a][c][O] = "0";
                ...
                k = { width: b[a].offsetWidth, opacity: 1 };
                b[a][c][g] = b[a][c][O] = "0";
                b[a][c][v] = w + "px"
            }
            V({}, j, a, b[a], i, k, h);
        ...
        var i = { b: x.a.j, c: a.c * 1.6, a: function () {
            l.o()
        } 
        };
        ...
        for (var q = { c: a.c / 1.3 }, k = 0, o = a.g * 2; k < o; k++) {
            for (var i = k, l = 0; l < a.m; l++) {
                if (i >= 0 && i < a.g) {
                    var m = f[l][i];
                    V(q, b[d], p, m, { width: 0, height: 0, opacity: 0 }, { width: m.w, height: m.h, opacity: 1 }, n);
                    p++
                }
                i--
            }
        ...
        for (var f = 0, b = 0, k = a[d]; b < k; b++) {
            ...
            if (j == 16) {
                a[b][c][g] = a[b][c][v] = "0px";
                var h = { width: 0, height: 0, opacity: 0 }, i = { width: e.w, height: e.h, opacity: 1 }
            } else {
                h = { opacity: 0 };
                i = { opacity: 1 }
            }
