...
namespace MPC.Repository.Repositories
{
    ...
    public class ItemRepository : BaseRepository<Item>, IItemRepository
    {
        ...
        //            if (objCompany != null)
        //            {
        //                // if include VAT is true then calculate tax...
        //                if (objCompany.isIncludeVAT == true)
        //                {
                           
        //                        CompanyTaxRate = objCompany.TaxRate ?? 0;
        //                        grossTotal = GrossTotalCalculation(netTotal, CompanyTaxRate);
        ...
        //            //else
        //            //{
        //            //    grossTotal = GrossTotalCalculation(netTotal, vwCompanySite.StateTaxValue);
        //            //}
        ...
        //                    SaveAdditionalAddonsOrUpdateStockItemType(SelectedAddOnsList, (int)newItem.ItemId, 0, 0, isCopyProduct); // additional addon required the newly inserted cloneditem
        //                }
        //                else
        //                {
        ...
        //        oTemplate.TemplateObject.Where(tempObject => tempObject.ObjectType == 3 && tempObject.IsQuickText != true).ToList().ForEach(item =>
        //        {
        ...
        //        oTemplate.TemplateBackgroundImage.ToList().ForEach(item =>
        //        {
        ...
        //public bool ResolveTemplateVariables(int productID, Company objCompany, CompanyContact objContact, StoreMode objMode, List<TemplateVariable> lstPageControls)
        //{
        ...
        //            tempObjs = db.TemplateObject.Where(g => g.ProductID == productID).ToList();
        ...
        //            db.SectionCostcentres.Where(c => c.ItemSectionId == SelectedtblItemSectionOne.ItemSectionId && c.IsOptionalExtra == 1).ToList().ForEach(db.DeleteObject);
